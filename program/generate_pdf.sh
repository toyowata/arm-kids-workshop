...
# 3. gripを使ってHTMLを出力
grip all_in_one.md --export all_in_one.html --title="プログラムの作り方" --user-content --wide
...
"/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" --headless --no-pdf-header-footer --print-to-pdf=workshop_manual.pdf all_in_one.html 2>/dev/null
